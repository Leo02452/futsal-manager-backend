...
-- AddForeignKey
ALTER TABLE `match_events` ADD CONSTRAINT `match_events_event_player_id_fkey` FOREIGN KEY (`event_player_id`) REFERENCES `players`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
